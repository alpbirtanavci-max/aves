...
Tamamlanmış işlerin devir/brief dosyaları. `AGENTS.md` bölüm 2: iş bitince buraya taşınır.

| Dosya | İş | Durum |
|---|---|---|
| `CODEX_BRIEF_rc3939_takip_atama_rls.md` | Takip atama RLS boşlukları — migration 79 brief'i | Tamamlandı (mig 79 canlıda, 2026-09-03) |
